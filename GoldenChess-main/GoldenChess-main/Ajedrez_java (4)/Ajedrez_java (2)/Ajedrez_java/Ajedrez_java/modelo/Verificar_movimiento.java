...
public class Verificar_movimiento {
    ...
    public ArrayList<Integer> nMovimiento(String value, String clave){
        ...
        if(value.equals("Caballo blanco") || value.equals("Caballo negro")){
            ...
            int currentPosition = Integer.parseInt(clave);
            boolean isStartingPosition = (currentPosition >= 9 && currentPosition <= 16) || (currentPosition >= 49 && currentPosition <= 56);
            
            if (value.equals("Peon blanco")) {
                int casillaArriba = currentPosition - 8;
                if (casillaArriba < 64 && casillaArriba > 0 && diccionario.get("" + casillaArriba).equals("Casilla")) {
                    nFichas.add(casillaArriba);
                }
                if (isStartingPosition) {
                    int dosCasillasArriba = currentPosition - 16;
                    int casillaEnMedio = currentPosition - 8;
                    if (diccionario.get("" + dosCasillasArriba).equals("Casilla") && diccionario.get("" + casillaEnMedio).equals("Casilla")) {
                        nFichas.add(dosCasillasArriba);
                    }
                }
                int casillaDiagonalIzquierda = currentPosition - 7;
                if (diccionario.get("" + casillaDiagonalIzquierda).matches(".*\\b(negro|negra)")) {
                    nFichas.add(casillaDiagonalIzquierda);
                }
                int casillaDiagonalDerecha = currentPosition - 9;
                if (diccionario.get("" + casillaDiagonalDerecha).matches(".*\\b(negro|negra)")) {
                    nFichas.add(casillaDiagonalDerecha);
                }
            } 
            else if (value.equals("Peon negro")) {
                int casillaAbajo = currentPosition + 8;
                if (casillaAbajo < 64 && casillaAbajo > 0 && diccionario.get("" + casillaAbajo).equals("Casilla")) {
                    nFichas.add(casillaAbajo);
                }
                if (isStartingPosition) {
                    int dosCasillasAbajo = currentPosition + 16;
                    int casillaEnMedio = currentPosition + 8;
                    if (diccionario.get("" + dosCasillasAbajo).equals("Casilla") && diccionario.get("" + casillaEnMedio).equals("Casilla")) {
                        nFichas.add(dosCasillasAbajo);
                    }
                }
                int casillaDiagonalIzquierda = currentPosition + 7;
                if (diccionario.get("" + casillaDiagonalIzquierda).matches(".*\\b(blanco|blanca)")) {
                    nFichas.add(casillaDiagonalIzquierda);
                }
                int casillaDiagonalDerecha = currentPosition + 9;
                if (diccionario.get("" + casillaDiagonalDerecha).matches(".*\\b(blanco|blanca)")) {
                    nFichas.add(casillaDiagonalDerecha);
                }
            }
        }
